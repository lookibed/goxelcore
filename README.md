...
### Принципы:
- Запрещено использование натурального интеллекта.
- Структура файлов и нейминг сохраняются 1:1.
- Используется `go-sdl3` с контекстом `OpenGL` (уже настроен).
- Для звука и шрифтов временно использовать заглушки.
